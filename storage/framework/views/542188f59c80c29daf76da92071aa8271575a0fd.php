                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      ...
                      <?php
                        $url_mapping = App\Helpers::generateRoute(App\Consts::TAXONOMY['product'], $row->title, $row->id, 'detail', $row->taxonomy_title);
                      ?>
                      <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\kon10ted\resources\views/admin/pages/cms_products/index.blade.php ENDPATH**/ ?>