          ...
          <div class="col-lg-6">
            <div class="event">
              ...
              <div class="event-content">
                ...
                <a class="event-more" href="<?php echo e($alias); ?>"><?php echo app('translator')->get('Read more'); ?></a>
              </div>
            </div>
          </div>
...
<?php echo $__env->make('frontend.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\furniture\resources\views/frontend/pages/resource/default.blade.php ENDPATH**/ ?>