      ...
      <div class="box-body table-responsive">
        ...
        <?php else: ?>
          <table class="table table-hover table-bordered">
            <thead>
              <tr>
                <th><?php echo app('translator')->get('Hình ảnh'); ?></th>
                ...
                <?php if($row->parent_id == 0 || $row->parent_id == null): ?>
                  <form action="<?php echo e(route(Request::segment(2) . '.destroy', $row->id)); ?>" method="POST"
                    ...
                    <tr class="valign-middle">
                      <td>
                        <img width="100" height="120" src="<?php echo e($row->image??""); ?>" alt="">
                      </td>
                      <td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\GBD_TEM\furniture\resources\views/admin/pages/cms_products/index.blade.php ENDPATH**/ ?>