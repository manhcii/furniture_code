                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <span class="input-group-btn">
                          <a data-input="pdf" data-preview="pdf-holder" class="btn btn-primary lfm" data-type="file">
                            <i class="fa fa-file-pdf-o"></i> <?php echo app('translator')->get('choose'); ?>
                          </a>
                        </span>
                        <input id="pdf" class="form-control" type="text" name="json_params[pdf]"
                          value="<?php echo e($detail->json_params->pdf ?? ''); ?>" placeholder="<?php echo app('translator')->get('Link file'); ?>...">
                      </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project\thaiever\resources\views/admin/pages/cms_products/create.blade.php ENDPATH**/ ?>